...
class TextGroup(object):
    ...
    def setupText(self):
        ...
        self.alltext[READYTXT] = Text("CUIDADIN CON LOS FANTASMAS", YELLOW, 1.15*TILEWIDTH, 20*TILEHEIGHT, size, visible=False)
        self.alltext[PAUSETXT] = Text("¿PAUSA PARA CAFE?", YELLOW, 6*TILEWIDTH, 20*TILEHEIGHT, size, visible=False)
        self.alltext[GAMEOVERTXT] = Text("LA CAGASTE, Y LO SABES", YELLOW, 2.5*TILEWIDTH, 20*TILEHEIGHT, size, visible=False)
        self.alltext[YOUWINTXT] = Text("¡ASI QUE NO ERAS TAN MALO!", YELLOW, 1.15*TILEWIDTH, 20*TILEHEIGHT, size, visible=False)
        self.addText("PUNTACOS", WHITE, 0, 0, size)
        self.addText("EL COMILON", WHITE, 18*TILEWIDTH, 10, size)
    ...
    def hideText(self):
        ...
        self.alltext[YOUWINTXT].visible = False
